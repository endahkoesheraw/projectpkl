	...
	<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
		...
		<div class="row">	
			...
			<div class="box box-success">
			 <div class="box-header with-border">
					<h3 class="box-title">Financial Criteria IPPPPPP</h3>
					&nbsp<small><b><i>*) Required</i></b></small>
             </div>
			</div>
        ...
        <div class="checkbox">
			...
			<div class="checkbox">
            <label>
            <input type="checkbox" name="AreaOfInterestMainMouth" value="1" id="MainMouth" onclick="MainMouthFunction()" />
                Main Mouth
            </label>
        </div>
			...
			<div class="box box-info" id="MainMouthForm" style="display:none">
					<div class="box-header">
					  <h3 class="box-title">Main Mouth</h3>
					</div>
              ...
              <div class="row">	
							...
							<div class="checkbox">
								<label>
								  <input type="checkbox" name="PreferenceMainMouthInvestor" value="1" />
								  Investor
								</label>
							</div>
							<div class="checkbox">
								<label>
								  <input type="checkbox" name="PreferenceMainMouthEPC" value="1" />
								  EPC Contractor     
								</label>
							</div>
							<div class="checkbox">
								<label>
								  <input type="checkbox" name="PreferenceMainMouthManufacturer" value="1" />
								  Manufacturer
								</label>
                </div>
                <div class="checkbox">
								<label>
								  <input type="checkbox" name="PreferenceMainMouthLandOwner" value="1" />
								  Land Owner     
								</label>
							</div>
							<div class="checkbox">
								<label>
								  <input type="checkbox" name="PreferenceMainMouthOperationMaintenance" value="1" />
								  Operation n Maintenance   
								</label>
							</div>
							<div class="checkbox">
								<label>
								  <input type="checkbox" name="PreferenceMainMouthPrimaryEnergy" value="1" />
								  Primary Energy
								</label>
              </div>
              <div class="checkbox">
								<label>
								  <input type="checkbox" name="PreferenceMainMouthConsultant" value="1" />
								  Consultant
								</label>
							</div>
						  </div>  
					...
					<div class="row">	
						...
						<div class="form-group">
						  <label>Notes Preference:</label>
						  <textarea class="form-control" rows="10" name="PreferenceMainMouthNotes" placeholder="Notes Preference" maxlength="10000"></textarea>
						  </div>
					  </div> 
					</div>
					</div>
