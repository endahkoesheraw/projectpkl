...
class Update_eoi_form_admin extends CI_Controller {
	...
	function index(){
		...
		$a['page']	= "view_eoi_submission_admin";	
	...
	function update($UId){
		...
		$a['page']	= "view_update_eoiform_admin";	
		$this->load->view('index', $a);
	...
	function proses(){
			...
			//form validation
			 ...
			 $this->form_validation->set_rules('BasicCompanyContactPerson1EmailAdress','Contact Person 1 Email ','required|valid_email');
			 ...
			 $this->form_validation->set_rules('BasicCompanyContactPerson2EmailAdress','Contact Person 2 Email ','required|valid_email'); 
		 ...
		 if($this->form_validation->run() == FALSE) {
			...
			$this->session->set_flashdata('result_login', '<br>Update failed');
			}
