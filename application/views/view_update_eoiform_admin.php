      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              <li><i class="fa fa-book"></i> Update EoI Submission</a></li>
            </ol>
          </section>
           ...
           <div class="box box-info">
			...
			<div class="box box-success">
			 ...
			 <?php  
				...
				<!-- form start -->
                <?php echo form_open_multipart('update_eoi_form_admin/proses'); ?>
				<!-- form start -->
			<div class="row">
				<div class="col-md-6">
			  ...
			  <div class="form-group">
			      <input type="hidden" class="form-control" name="UId" placeholder="User Id"  value="<?php echo $uid;?>"/>
			 </div>		
             </div>
		</div>
		</br>
		...
		<div class="row">	
			...
			<div class="row">	
				...
				<!-- Start Hydroelectric Power Plant (PP)-->
				  <div class="box box-info" id="HydroelectricForm" <?php if($AreaOfInterestHydroelectricPowerPlant=="0"){echo "style=\"display:none\"";} ?>>
				...
				<!-- Geothermal Form -->
				   <div class="box box-info" id="GeothermalForm" <?php if($AreaOfInterestGeothermalPP=="0"){echo "style=\"display:none\"";} ?>>
					<div class="box-header">
				...
				<!-- Solar Photovoltaic Form -->
				  <div class="box box-info" id="SolarPhotovoltaicForm" <?php if($AreaOfInterestSolarPhotovoltaicPP=="0"){echo "style=\"display:none\"";} ?> onclick="SolarPhotovoltaicFunction()">
					<div class="box-header">
				...
				<!-- SolarThermal Form -->
				  <div class="box box-info" id="SolarThermalForm" <?php if($AreaOfInterestSolarThermalPP=="0"){echo "style=\"display:none\"";} ?>>
					<div class="box-header">
				  ...
				  <!-- WindPower Form -->
				  <div class="box box-info" id="WindPowerForm" <?php if($AreaOfInterestWindPowerPP=="0"){echo "style=\"display:none\"";} ?> >
					<div class="box-header">
				...
				<!-- EnergyStorage Form -->
				  <div class="box box-info" id="EnergyStorageForm" <?php if($AreaOfInterestEnergyStoragePumpedPP=="0"){echo "style=\"display:none\"";} ?>>
					<div class="box-header">
				...
				<!-- SeaEnergy Form -->
				   <div class="box box-info" id="SeaEnergyForm" <?php if($AreaOfInterestSeaEnergyPP=="0"){echo "style=\"display:none\"";} ?>>
					<div class="box-header">
				  ...
				  <!-- WasteToEnergy Form -->
				  <div class="box box-info" id="WastetoEnergyForm" <?php if($AreaOfInterestWastetoEnergyPP=="0"){echo "style=\"display:none\"";} ?>>
					<div class="box-header">
				...
				<!-- Nuclear Form -->
				  <div class="box box-info" id="NuclearEnergyForm" <?php if($AreaOfInterestNuclearEnergyPP=="0"){echo "style=\"display:none\"";} ?>>
					<div class="box-header">
				...
				<!-- OtherClean Form -->
				  <div class="box box-info" id="OtherCleanEnergyForm" <?php if($AreaOfInterestOtherCleanTechnologyPP=="0"){echo "style=\"display:none\"";} ?> >
					<div class="box-header">
                        ...
                        <tbody id="itemlist">
										...
										<tr>
										  ...
										  <?php echo htmlentities($ProjectType[$x]); ?>
											<option selected="selected" value="<?php echo $ProjectType[$x]; ?>"><?php echo $ProjectType[$x]; ?></option>
                        ...
                        <div class="alert alert-success">
							...
							<script>
								$(document).ready(function() {
									window.setTimeout(function(){window.location.href = "<?php echo base_url().'eoi_submission_admin'?>"},3000);
								});
							</script>
                        </div>    
                    <?php } ?>
