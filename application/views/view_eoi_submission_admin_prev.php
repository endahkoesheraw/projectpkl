      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
          <section class="content-header">
            <h1>
				 EoI Submission Preview
            </h1>
            <ol class="breadcrumb">
			  <li><a href="#"><i class="fa fa-user"></i> Administrator</a></li>
            <li><a href="<?php echo base_url()."users_admin"; ?>"><i class="fa fa-book"></i> Review EoI Submission</a></li>
			  <li><i></i>  EoI Submission Preview</a></li>
            </ol>
          </section>
			...
			<div class="box-header with-border">
			  ...
			  <div class="box-header with-border">
					<button class="btn btn-warning ?>" onclick="goBack()"><i class="fa fa-undo"></i> Go Back</button>
					  <a  href="<?php echo base_url().'export_excel_eoi/export_submissiondetailwithexp/'.$UId; ?>"  class="btn btn-info"><i  class="fa fa-file-excel-o"  ></i> Export</a>	
              </div>
