    ...
    <head>
     ...
     <body class="login-page">
		...
		<center><a href=<?php echo base_url() ?> class="logo"><img src="<?php echo base_url('assets/img/pjblogo.png'); ?>" /></a></br><h3><b>Expression Of Interest (EoI)</b></h3></center>
                <p class="login-box-msg">Fill in the New Password and Confirm Password fields to reset your password. </p>
                <?php echo form_open('forgot_password/reset/token/'.$token); ?>  
