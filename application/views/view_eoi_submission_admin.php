...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           Manage EoI Submission
          </h1>
          <ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-user"></i> Administrator</a></li>
            <li><a href="<?php echo base_url()."eoi_submission_admin"; ?>"><i class="fa fa-users"></i> Manage EoI Submission</a></li>
          </ol>
        </section>
						...
						<td><?php echo $BasicCompanyYearEstablished ?></td>           
						 <td align="center">
                          <div class="btn-group" role="group">
                            <a class="btn btn-sm btn-primary" href="<?= base_url().'eoi_submission_admin/eoi_submission_prev/'.$CompanyID; ?>" title="Preview"><i class="fa fa-search"></i></a>
						</div>
						<div class="btn-group" role="group">
                            <a class="btn btn-sm btn-warning" href="<?php echo base_url().'update_eoi_form_admin/update/'.$UId; ?>" title="Update"><i class="fa fa-refresh"></i></a>
						</div>
						<div class="btn-group" role="group">
                            <a class="btn btn-sm btn-danger" href="<?php echo base_url().'delete_eoi_form/delete_eoi_admin/'.$UId; ?>" onclick="return confirm('Are you sure you want to delete this item?');"  title="Delete"><i class="fa fa-trash"></i></a>
						</div>
                    	</tr>
                    <?php $i++;} ?>
                </tbody>
